    ...
    return (
        <div className="bg-orange-50 w-full min-h-screen">
            <div className="max-w-7xl m-auto h-screen p-4 md:p-20 flex flex-col">
                ...
                <h1 className="font-bold text-[7rem] m-0 leading-none mt-[3rem]">Server Error</h1>
                <h1 className="font-regular text-[1.5rem] m-0 leading-none">An unexpected error occured on the server. Please try again later.</h1>
